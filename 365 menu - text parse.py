...
for line in read:
	...
	tempName = line.split('âˆ’âˆ’')[1]
	recipeName = tempName.split('.')[0]

	newTemp = tempName.split('.',1)[1]
	newTemp2 = newTemp[2:]
	recipeList.append({recipeName, newTemp})
	print(str(counter)+ "|" + recipeName + "|" + newTemp2)
	counter += 1
